define(function(require, exports, module) {
	...
	directives.eBillAmountInput = ['$timeout', function ($timeout) {
		var TPL = ['<div class="input-group clearfix">',
						...
						'<input name="noDecimal"  placeholder="0" lp-number-input lp-max-length="6" min="0" max="999999" class="form-control whole-amount-input pull-left text-right" type="number" ng-model="noDecimal"/>',
