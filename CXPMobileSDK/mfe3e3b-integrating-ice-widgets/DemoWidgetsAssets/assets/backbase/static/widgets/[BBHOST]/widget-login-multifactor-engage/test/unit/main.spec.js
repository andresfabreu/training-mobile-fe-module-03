...
describe('Login Multifactor widget test suite', function() {
    ...
    describe('Controllers', function() {
        ...
        describe('MainCtrl', function() {
            ...
            it('should handle errors', inject(function($timeout) {
            ...
            it('should clean handled errors', inject(function($timeout) {
                var errorMessage = 'Test error';
                scope.$emit('error', { message: errorMessage });
                $timeout.flush();
        ...
        describe('One Time Password Controller', function() {
            ...
            it('should raise an error when finishing the timer', inject(function($timeout) {
                spyOn(scope, '$emit');
                ctrl.finish();
                $timeout.flush();
