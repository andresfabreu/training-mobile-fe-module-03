define(function(require, exports, module) {
	 ...
	 *
	 * @param  fn {function} The callback function to be called
	 * @return    Returns the requestAnimationFrame function result
	 */
				...
				var resizeListener = function(event) {
					...
					resizeId = requestFrame(function() {
						if (checkResize()) {
							...
							callback(scope, { data: { width: resizeTarget.offsetWidth, height: resizeTarget.offsetHeight } });
						}
					});
				};
