...
define(function (require, exports) {
    ...
    // @ngInject
    exports.NavBarAdvancedController = function($scope, $timeout, lpWidget, lpCoreBus, lpCoreUtils) {
        ...
        var initialize = function () {
            ...
            $scope.isDesignMode = bd && util.parseBoolean(bd.designMode);
        ...
        if(b$ && b$.portal){
            ...
            $widgetBody.find('a[data-uuid="' + b$.portal.linkUUID + '"]').parents('li').addClass('active');
