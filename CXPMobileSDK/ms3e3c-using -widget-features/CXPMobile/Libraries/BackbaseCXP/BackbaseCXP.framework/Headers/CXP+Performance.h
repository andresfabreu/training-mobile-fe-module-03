 ...
 * <code>gadgets.pubsub.publish("cxp.performance.start", {"operation":"operation", "id": "objId"})</code>
 ...
 * @discussion It's possible to start this event performances from javascript widgets. In order to do so, send a pubsub
 * <code>gadgets.pubsub.publish("cxp.performance.end", {"operation":"operation"})</code>
