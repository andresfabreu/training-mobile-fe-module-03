        ...
        return {
            ...
            link: function(scope, element, attrs, ctrls) {
                ...
                scope.getSelection = function(event) {
                    ...
                    textSelection = util.getSelectionPositionOfInput(accountInput, noSeparatorSelection);
                ...
                scope.setCursorPosition = function() {
                    ...
                    var cursorPosition = util.getNewCaretPosition(accountInput, textSelection, lengthDiff, isBackspace);
                    ...
                    $timeout(function() {
                        util.setCaretPositionOfInput(accountInput, cursorPosition, scope.paymentReference, $partialText);
                    }, 20, false);
                };
