        ...
        scope.$watch('gmCenter', function (newValue, oldValue) {
          ...
          if (changed && !controller.dragging) {
            ...
            if (latLng)
              ...
              controller._map.panTo(latLng); // Fix IE8 issue
          }
        }, true);
      }
...
'use strict';
  ...
  controller('angulargmMapController',
    ...
    var constructor = function($scope, $element) {
      ...
      // to check if it is old browser (like IE8)
      var es3Browser = angulargmUtils.isOldBrowser();

      if (!es3Browser) {
        // stuff, supported by new browsers
