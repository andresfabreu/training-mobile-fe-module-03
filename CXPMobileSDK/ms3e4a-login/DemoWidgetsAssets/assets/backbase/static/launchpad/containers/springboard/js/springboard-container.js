...
(function () {
     ...
     * @constant {String}
     */
    var SPRINGBOARD_CHROME = "$(contextRoot)/static/launchpad/universal/chromes/springboard/chrome-springboard.html";
...
//  ----------------------------------------------------------------
    var SpringboardContainer = Container.extend(function (bdomDocument, node) {
        ...
        DOMReady: function () {
            var self = this;
            this.springboard = new lp.Springboard({
            ...
            window.setTimeout(function() {
                ...
                self.allowResize = self.allowPersonalize && lp.util.parseBoolean(self.getPreference("allowUserResize"));

                if(lp.util.isDesignMode() || self.allowResize) {
                ...
                require(['ui'], function(ui) {
                    var responsive = lp.responsive.enable(self.$body[0]);
            ...
            gadgets.pubsub.subscribe("widgetCatalogLoaded", function() {
                ...
                self.$body
                    ...
                    .on("mouseenter", selectors.FREE_AREA_HOLDER, function () {
                        ...
                        //$('.bp-area', this).html('<div class="lp-springboard-add"><i class="text-light lp-icon lp-icon-xxxl lp-icon-plus"></i></div>');
        ...
        template: function(json) {
            ...
            var sTemplate = launchpad.SpringboardContainer(data);
            return sTemplate;
        }
    });
})();
