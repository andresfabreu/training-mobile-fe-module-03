define(function(require, exports, module) {
    ...
    module.exports = [
        ...
        '            <div dropdown-select="dropdown-select" ng-options="option as option for option in sort.options" ng-model="sort.selected" ng-change="changeSort()" class="input-group-btn sort-select" option-template-url="$transactions/sortDropdownOption.html" align="\'right\'"',
