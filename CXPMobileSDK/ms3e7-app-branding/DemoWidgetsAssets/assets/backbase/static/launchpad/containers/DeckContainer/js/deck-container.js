...
(function(b$, gadgets, lp, bd, be, bc, window, $) {
    'use strict';
    ...
    var DeckContainer = Container.extend(function(bdomDocument, node) {
        ...
        DOMReady: function(e) {
            var self = this;
            this.initialized = lp.util.parseBoolean(this.getPreference('initialized'));
            ...
            window.setTimeout(function() {
                ...
                if (showControls) {
                    ...
                    if (bd.designMode) {
                        rs.addURI('text/javascript', bd.contextRoot + '/static/launchpad/containers/DeckContainer/js/deck-container-designmode.js');
        ...
        addPanel: function(data, callback) {
            ...
            var createPanelInstanceTemplate = be.utils.processXMLTemplateByUrl(b$.portal.config.serverRoot + '/static/launchpad/containers/DeckContainer/templates/xml/createPanel.xml', tplData);
...
})(b$, gadgets, lp, bd, be, window.bc, window, $);