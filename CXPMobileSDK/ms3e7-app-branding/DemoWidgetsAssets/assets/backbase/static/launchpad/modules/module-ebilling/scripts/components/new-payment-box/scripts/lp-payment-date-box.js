            ...
            '<div class="e-bill-info-wrapper">' +
                '<ul tabset="tabset" class="tabset">' +
                    ...
                    '<li tab="tab" select="scheduledTransfer()">' +
                        '<span tab-heading="tab-heading" class="tab-heading" lp-i18n="Scheduled"></span>' +
                        '<div scheduled-transfer="scheduled-transfer" ng-model="paymentOrder.scheduledTransfer">' +
                        '</div>' +
                    '</li>' +
                '</ul>' +
            '</div>' +
